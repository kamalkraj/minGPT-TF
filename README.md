...
A TensorFlow re-implementation of [mingpt](https://github.com/karpathy/minGPT/)
![mingpt-tf](mingpt-tf2.jpg)

### Notebooks

`play_math.ipynb` and `play_char.ipynb` trained in [colab](https://colab.research.google.com/).Links are on the top of each notebook to train model on colab. `play_char.ipynb` notebook `batch_size` is reduced to fit in to colab `GPU` memory. Change the parameters according to GPU memory.


# [minGPT](https://github.com/karpathy/minGPT/) - Readme
![mingpt](mingpt.jpg)
